...
define(["module", "vwf/model", "vwf/utility"], function(module, model, utility) {
    ...
    return model.load(module, {
        ...
        creatingNode: function(nodeID, childID, childExtendsID, childImplementsIDs,
            ...
            var behaviors = (childImplementsIDs || []).map(function(childImplementsID) {
                return jsPredictSelf.nodes[childImplementsID];
            });
            ...
            behaviors.forEach(function(behavior) {
                prototype = proxiedBehavior.call(jsPredictSelf, prototype, behavior);
            });
            ...
            Object.defineProperty(node.properties, "create", {
                value: function(name, value, get, set) { // "this" is node.properties
                    return jsPredictSelf.kernel.createProperty(this.node.id, name, value, get, set);
                }
            });
            ...
            Object.defineProperty(node.methods, "create", {
                value: function(name, parameters, body) { // "this" is node.methods  // TODO: also accept create( name, body )
                    return jsPredictSelf.kernel.createMethod(this.node.id, name, parameters, body);
                }
            });
            ...
            Object.defineProperty(node.events, "create", {
                value: function(name, parameters) { // "this" is node.events
                    return jsPredictSelf.kernel.createEvent(this.node.id, name, parameters);
                }
            });
            ...
            Object.defineProperty(node.children, "create", {
                value: function(name, component, callback /* ( child ) */ ) { // "this" is node.children
                    return jsPredictSelf.kernel.createChild(this.node.id, name, component /* , callback */ ); // TODO: support callback and map callback's childID parameter to the child node
                }
            });

            Object.defineProperty(node.children, "delete", {
                value: function(child) {
                    return jsPredictSelf.kernel.deleteNode(child.id);
                }
            });
            ...
            Object.defineProperty(node, "time", { // TODO: only define on shared "node" prototype?
                get: function() {
                    return jsPredictSelf.kernel.time();
                },
                enumerable: true,
            });
            ...
            Object.defineProperty(node, "client", { // TODO: only define on shared "node" prototype?
                get: function() {
                    return jsPredictSelf.kernel.client();
                },
                enumerable: true,
            });
            ...
            Object.defineProperty(node, "moniker", { // TODO: only define on shared "node" prototype?
                get: function() {
                    return jsPredictSelf.kernel.moniker();
                },
                enumerable: true,
            });
            ...
            Object.defineProperty(node, "Scene", { // TODO: only define on shared "node" prototype?
                get: function() {
                    return jsPredictSelf.nodes['index-vwf'];
                },
                enumerable: true,
            });
            ...
            Object.defineProperty(node, "in", { // TODO: only define on shared "node" prototype?
                value: function(when, callback) { // "this" is node
                    return refreshedFuture.call(jsPredictSelf, this, -when, callback); // relative time
                },
                enumerable: true,
            });
            ...
            Object.defineProperty(node, "at", { // TODO: only define on shared "node" prototype?
                value: function(when, callback) { // "this" is node
                    return refreshedFuture.call(jsPredictSelf, this, when, callback); // absolute time
                },
                enumerable: true,
            });
                ...
                (function() {
                    ...
                    Object.defineProperty(watchable, _i, {
                        set: function(value) {
                            ...
                            jsPredictSelf.setWatchableValue(this.id, this.propertyname, this.internal_val, this.dotNotation);
                        },
                        get: function() {
                            ...
                            ret = jsPredictSelf.createWatchable(ret, this.propertyname, this.id, this.masterval, this.dotNotation + '.' + _i);
                            return ret;
                        },
                        configurable: true,
                        enumerable: true
                ...
                value: function(name, newvalue) {
                    Object.defineProperty(this, name, {
                        ...
                        get: function() {
                            ...
                            //This recursively builds new watchables, such that you can do things like
                            //this.materialDef.layers[0].alpha -= .1;
                            ret = jsPredictSelf.createWatchable(ret, this.propertyname, this.id, this.masterval, this.dotNotation + '.' + name);
                            return ret;
                        },
                        configurable: true,
                        enumerable: true
        ...
        setupWatchableArray: function(watchable, val, propertyname, id, masterval, dotNotation) {
            ...
            watchable.push = function(newval) {
                ...
                jsPredictSelf.setWatchableValue(this.id, this.propertyname, this.internal_val, this.dotNotation);
                jsPredictSelf.setupWatchableArray(this, internal, this.propertyname, this.id, this.masterval, this.dotNotation);
            }
        ...
        setWatchableValue: function(id, propertyName, value, dotNotation) {
            ...
            if (this.__WatchableCache[masterid]) {
                ...
                jsPredictSelf.kernel.setProperty(id, propertyName, this.__WatchableCache[masterid].masterval);
                ...
                jsPredictSelf.kernel.setProperty(id, propertyName, value);
        ...
        //create a new watchable for a given value. Val is the object itjsPredictSelf, and masterval is the root property of the node
        createWatchable: function(val, propertyname, id, masterval, dotNotation) {
            ...
            if (val instanceof jsPredictSelf._Watchable) {
                return jsPredictSelf.createWatchable(val.internal_val, propertyname, id, undefined, dotNotation)
            ...
            if (val.constructor == Array || val instanceof Float32Array) {
                ...
                var watchable = new jsPredictSelf._Watchable();
                console.log('new watchable', dotNotation);
                watchable.dotNotation = dotNotation;
                jsPredictSelf.setupWatchableArray(watchable, val, propertyname, id, masterval, dotNotation);
                ...
                console.log('new watchable', dotNotation);
                watchable.dotNotation = dotNotation;
                jsPredictSelf.setupWatchableObject(watchable, val, propertyname, id, masterval, dotNotation);
                this.__WatchableCache[dotNotation] = watchable;
                return watchable;
        ...
        watchableToObject: function(watchable) {
            ...
            if (watchable instanceof jsPredictSelf._Watchable) {
        ...
        initializingProperty: function(nodeID, propertyName, propertyValue) {
            ...
            Object.defineProperty(node.properties, propertyName, { // "this" is node.properties in get/set
                get: function() {
                    ...
                    if (jsPredictSelf.__WatchableCache[this.node.id + "-" + propertyName]) {
                        ...
                        //  this.updateWatchableCache(this.node.id,propertyName,jsPredictSelf.kernel.getProperty(this.node.id, propertyName));
                        return jsPredictSelf.__WatchableCache[this.node.id + "-" + propertyName];
                    } else
                        return jsPredictSelf.createWatchable(jsPredictSelf.kernel.getProperty(this.node.id, propertyName), propertyName, this.node.id, undefined, this.node.id + "-" + propertyName)

                },
                set: function(value) {
                    jsPredictSelf.setWatchableValue(this.node.id, propertyName, jsPredictSelf.watchableToObject(value), this.node.id + "-" + propertyName)
                },
                enumerable: true
            });
            ...
            if (!node.hasOwnProperty(propertyName)) // TODO: recalculate as properties, methods, events and children are created and deleted; properties take precedence over methods over events over children, for example
            {
                Object.defineProperty(node, propertyName, { // "this" is node in get/set
                    get: function() {
                        ...
                        //return a watchable from the cache if it exists. This is way way way too slow. 
                        //trying to be very careful to keep the cache working properly;
                        if (jsPredictSelf.__WatchableCache[this.id + "-" + propertyName]) {
                            //because other drivers might change the value, we have to update the cache on every get.
                            //this is  too bad, because it's a lot of work, but we shoudl be able to keep the watchable strucures
                            //even if we have to update the underlying cache.
                            ...
                            var currentval = jsPredictSelf.kernel.getProperty(this.id, propertyName);
                            if (!currentval) return currentval;
                            //it's possible to fail to compate on circular json
                            try {
                                if (JSON.stringify(currentval) != JSON.stringify(jsPredictSelf.__WatchableCache[this.id + "-" + propertyName].internal_val)) {
                                    ...
                                    // return jsPredictSelf.createWatchable(currentval, propertyName, this.id, undefined, this.id + "-" + propertyName)
                                    jsPredictSelf.updateWatchableCache(this.id, propertyName, currentval)
                                }
                                return jsPredictSelf.__WatchableCache[this.id + "-" + propertyName];
                            } catch (e) {
                                return jsPredictSelf.createWatchable(jsPredictSelf.kernel.getProperty(this.id, propertyName), propertyName, this.id, undefined, this.id + "-" + propertyName)
                            }
                        } else
                            return jsPredictSelf.createWatchable(jsPredictSelf.kernel.getProperty(this.id, propertyName), propertyName, this.id, undefined, this.id + "-" + propertyName)
                    ...
                    set: function(value) {
                        jsPredictSelf.setWatchableValue(this.id, propertyName, jsPredictSelf.watchableToObject(value), this.id + "-" + propertyName)
                    },
                    enumerable: true
                });
            }
            ...
            Object.defineProperty(node.methods, methodName, { // "this" is node.methods in get/set
                get: function() {
                    return function( /* parameter1, parameter2, ... */ ) { // "this" is node.methods
                        return jsPredictSelf.kernel.callMethod(this.node.id, methodName, arguments);
                    };
                },
                set: function(value) {
                    this.node.methods.hasOwnProperty(methodName) ||
                        jsPredictSelf.kernel.createMethod(this.node.id, methodName);
            ...
            Object.defineProperty(node, methodName, { // "this" is node in get/set
                get: function() {
                    return function( /* parameter1, parameter2, ... */ ) { // "this" is node
                        return jsPredictSelf.kernel.callMethod(this.id, methodName, arguments);
                    };
                },
                set: function(value) {
                    this.methods.hasOwnProperty(methodName) ||
                        jsPredictSelf.kernel.createMethod(this.id, methodName);
        ...
        creatingEvent: function(nodeID, eventName, eventParameters, eventBody) {
            ...
            Object.defineProperty(node.events, eventName, { // "this" is node.events in get/set
                get: function() {
                    return function( /* parameter1, parameter2, ... */ ) { // "this" is node.events
                        return jsPredictSelf.kernel.fireEvent(this.node.id, eventName, arguments);
                    };
                },
                set: function(value) {
            ...
            Object.defineProperty(node, eventName, { // "this" is node in get/set
                get: function() {
                    return function( /* parameter1, parameter2, ... */ ) { // "this" is node
                        return jsPredictSelf.kernel.fireEvent(this.id, eventName, arguments);
                    };
                },
                set: function(value) {
                    var listeners = this.private.listeners[eventName] ||
        ...
        firingEvent: function(nodeID, eventName, eventParameters) {
            ...
            var handled = listeners && listeners.reduce(function(handled, listener) {
                ...
                if (!phase || listener.phases && listener.phases.indexOf(phase) >= 0) {
                    ...
                    var result = listener.handler.apply(listener.context || jsPredictSelf.nodes[0], eventParameters); // default context is the global root  // TODO: this presumes this.creatingNode( undefined, 0 ) is retained above
            ...
            handled = handled || phase != 'bubble' && node.children && node.children.reduce( function( handled, child ) {
                        ...
                        var result = handled || jsPredictSelf.firingEvent(child.id,eventName, eventParameters); // default context is the global root  // TODO: this presumes this.creatingNode( undefined, 0 ) is retained above
                        return handled || result===true || result===undefined; // interpret no return as "return true"
            }, handled );*/
            ...
            if (behavior.properties.hasOwnProperty(propertyName)) {
                ...
                (function(propertyName) {
                    ...
                    Object.defineProperty(proxy.properties, propertyName, { // "this" is proxy.properties in get/set
                        get: function() {
                            return jsPredictSelf.kernel.getProperty(this.node.id, propertyName)
                        },
                        set: function(value) {
                            jsPredictSelf.kernel.setProperty(this.node.id, propertyName, value)
                        },
                        enumerable: true
                    });
                    ...
                    Object.defineProperty(proxy, propertyName, { // "this" is proxy in get/set
                        get: function() {
                            return jsPredictSelf.kernel.getProperty(this.id, propertyName)
                        },
                        set: function(value) {
                            jsPredictSelf.kernel.setProperty(this.id, propertyName, value)
                        },
                        enumerable: true
                    });
                ...
                if (node.properties.hasOwnProperty(propertyName)) {
                    ...
                    (function(propertyName) {
                        ...
                        Object.defineProperty(future.properties, propertyName, { // "this" is future.properties in get/set
                            get: function() {
                                return jsPredictSelf.kernel.getProperty(this.future.id,
                                    propertyName, this.future.private.when, this.future.private.callback
                                )
                            },
                            set: function(value) {
                                jsPredictSelf.kernel.setProperty(this.future.id,
                        ...
                        Object.defineProperty(future, propertyName, { // "this" is future in get/set
                            get: function() {
                                return jsPredictSelf.kernel.getProperty(this.id,
                                    propertyName, this.private.when, this.private.callback
                                )
                            },
                            set: function(value) {
                                jsPredictSelf.kernel.setProperty(this.id,
                        ...
                        Object.defineProperty(future.methods, methodName, { // "this" is future.methods in get/set
                            get: function() {
                                return function( /* parameter1, parameter2, ... */ ) { // "this" is future.methods
                                    return jsPredictSelf.kernel.callMethod(this.future.id,
                        ...
                        Object.defineProperty(future, methodName, { // "this" is future in get/set
                            get: function() {
                                return function( /* parameter1, parameter2, ... */ ) { // "this" is future
                                    return jsPredictSelf.kernel.callMethod(this.id,
                ...
                if (node.events.hasOwnProperty(eventName)) {
                    ...
                    (function(eventName) {
                        ...
                        Object.defineProperty(future.events, eventName, { // "this" is future.events in get/set
                            get: function() {
                                return function( /* parameter1, parameter2, ... */ ) { // "this" is future.events
                                    return jsPredictSelf.kernel.fireEvent(this.future.id,
                        ...
                        Object.defineProperty(future, eventName, { // "this" is future in get/set
                            get: function() {
                                return function( /* parameter1, parameter2, ... */ ) { // "this" is future
                                    return jsPredictSelf.kernel.fireEvent(this.id,
    ...
    function nodeInstanceOf(node, type) {
        while (node) {
            ...
            if (vwf.prototype(node.id))
                node = jsPredictSelf.nodes[vwf.prototype(node.id)];
            else
                node = null;
    ...
    function findListeners(node, eventName, targetOnly) {
        ...
        var prototypeListeners = Object.getPrototypeOf(node).private ? // get any jsPredictSelf-targeted listeners from the prototypes
        ...
        if (targetOnly) {
            return prototypeListeners.concat(nodeListeners.filter(function(listener) {
                return listener.context == node || listener.context == node.private.origin; // in the prototypes, select jsPredictSelf-targeted listeners only
            }));
        } else {
