    ...
    return model.load( module, {
        ...
        creatingNode: function( nodeID, childID, childExtendsID, childImplementsIDs,
            ...
            var behaviors = ( childImplementsIDs || [] ).map( function( childImplementsID ) {
                return jsDriverPredict.nodes[childImplementsID];
            } );
            ...
            behaviors.forEach( function( behavior ) {
                prototype = proxiedBehavior.call( jsDriverPredict, prototype, behavior );
            } );
...
node.id = childID; // TODO: move to vwf/model/object
            ...
            Object.defineProperty( node.properties, "create", {
                value: function( name, value, get, set ) { // "this" is node.properties
                    return jsDriverPredict.kernel.createProperty( this.node.id, name, value, get, set );
                }
            } );
            ...
            Object.defineProperty( node.methods, "create", {
                value: function( name, parameters, body ) { // "this" is node.methods  // TODO: also accept create( name, body )
                    return jsDriverPredict.kernel.createMethod( this.node.id, name, parameters, body );
                }
            } );
            ...
            Object.defineProperty( node.events, "create", {
                value: function( name, parameters ) { // "this" is node.events
                    return jsDriverPredict.kernel.createEvent( this.node.id, name, parameters );
                }
            } );
            ...
            Object.defineProperty( node.children, "create", {
                value: function( name, component, callback /* ( child ) */ ) { // "this" is node.children
                    return jsDriverPredict.kernel.createChild( this.node.id, name, component /* , callback */ );  // TODO: support callback and map callback's childID parameter to the child node
                }
            } );

            Object.defineProperty( node.children, "delete", {
                value: function( child ) {
                    return jsDriverPredict.kernel.deleteNode( child.id );
                }
            } );
            ...
            Object.defineProperty( node, "time", {  // TODO: only define on shared "node" prototype?
                get: function() {
                    return jsDriverPredict.kernel.time();
                },
                enumerable: true,
            } );
            ...
            Object.defineProperty( node, "client", {  // TODO: only define on shared "node" prototype?
                get: function() {
                    return jsDriverPredict.kernel.client();
                },
                enumerable: true,
            } );
            ...
            Object.defineProperty( node, "moniker", {  // TODO: only define on shared "node" prototype?
                get: function() {
                    return jsDriverPredict.kernel.moniker();
                },
                enumerable: true,
            } );
	    ...
	    Object.defineProperty( node, "Scene", {  // TODO: only define on shared "node" prototype?
                get: function() {
                    return jsDriverPredict.nodes['index-vwf'];
                },
                enumerable: true,
            } );
            ...
            Object.defineProperty( node, "in", {  // TODO: only define on shared "node" prototype?
                value: function( when, callback ) { // "this" is node
                    return refreshedFuture.call( jsDriverPredict, this, -when, callback ); // relative time
                },
                enumerable: true,
            } );
            ...
            Object.defineProperty( node, "at", {  // TODO: only define on shared "node" prototype?
                value: function( when, callback ) { // "this" is node
                    return refreshedFuture.call( jsDriverPredict, this, when, callback ); // absolute time
                },
                enumerable: true,
            } );
		...
		setupWatchableObject: function (watchable,val,propertyname,id,masterval,dotNotation)
		{
				...
				for(var i = 0; i < keys.length; i++)
				{
					...
					Object.defineProperty(watchable,_i,{set:function(value){
						...
						jsDriverPredict.setWatchableValue(this.id,this.propertyname,this.internal_val,this.dotNotation);
					},
					get:function(){
						...
						ret =  jsDriverPredict.createWatchable(ret,this.propertyname,this.id,this.masterval,this.dotNotation+'.'+_i);
						return ret;
				...
				value:function(name,newvalue)
				{
					...
					get:function(){
						...
						//This recursively builds new watchables, such that you can do things like
						//this.materialDef.layers[0].alpha -= .1;
						ret =  jsDriverPredict.createWatchable(ret,this.propertyname,this.id,this.masterval,this.dotNotation+'.'+name);
						return ret;
					},configurable:true,enumerable:true});
					this[name] = newvalue;
		...
		setupWatchableArray: function (watchable,val,propertyname,id,masterval,dotNotation)
		{
				...
				watchable.push = function(newval)
				{
					...
					jsDriverPredict.setWatchableValue(this.id,this.propertyname,this.internal_val,this.dotNotation);
					jsDriverPredict.setupWatchableArray(this,internal,this.propertyname,this.id,this.masterval,this.dotNotation);
				}
		...
		setWatchableValue: function(id, propertyName, value, dotNotation)
		{
			...
			if(this.__WatchableCache[masterid])
			{
				...
				try{
				jsDriverPredict.kernel.setProperty(id,propertyName,this.__WatchableCache[masterid].masterval);
				}catch(e)
				{
			...
			{	this.__WatchableSetting ++;
				try{
				jsDriverPredict.kernel.setProperty(id,propertyName,value);
				}catch(e)
				{
		...
		//create a new watchable for a given value. Val is the object itjsDriverPredict, and masterval is the root property of the node
		createWatchable : function(val,propertyname,id,masterval,dotNotation)
		{
			...
			if(val instanceof jsDriverPredict._Watchable)
			{
				return jsDriverPredict.createWatchable(val.internal_val,propertyname,id,undefined,dotNotation)
			...
			if(val.constructor == Array || val instanceof Float32Array)
			{
				...
				var watchable = new jsDriverPredict._Watchable();
				watchable.dotNotation = dotNotation;
				jsDriverPredict.setupWatchableArray(watchable,val,propertyname,id,masterval,dotNotation);
			...
			else if(val.constructor == Object)
			{
				...
				var watchable = new jsDriverPredict._Watchable();
				watchable.dotNotation = dotNotation;
				jsDriverPredict.setupWatchableObject(watchable,val,propertyname,id,masterval,dotNotation);
				this.__WatchableCache[dotNotation] = watchable;
				return watchable;
		...
		{	
			...
			if(watchable instanceof jsDriverPredict._Watchable)
			{
		...
		return jsDriverPredict.createWatchable(jsDriverPredict.kernel.getProperty( this.node.id, propertyName ),propertyName,this.node.id,undefined,this.node.id+"-"+propertyName) 
		
		},
                set: function( value ) { jsDriverPredict.setWatchableValue( this.node.id, propertyName, jsDriverPredict.watchableToObject(value), this.node.id+"-"+propertyName ) },
                enumerable: true
            } );
	    ...
	    if(!node.hasOwnProperty( propertyName ) ) // TODO: recalculate as properties, methods, events and children are created and deleted; properties take precedence over methods over events over children, for example
	    {
		    Object.defineProperty( node, propertyName, { // "this" is node in get/set
		       ...
		       return jsDriverPredict.createWatchable(jsDriverPredict.kernel.getProperty( this.id, propertyName ),propertyName,this.id,undefined,this.id+"-"+propertyName) 
		       },
			set: function( value ) { jsDriverPredict.setWatchableValue( this.id, propertyName, jsDriverPredict.watchableToObject(value) , this.id+"-"+propertyName) },
			enumerable: true
		    } );
	    }
...
if ( ! node ) return;  // TODO: patch until full-graph sync is working; drivers should be able to assume that nodeIDs refer to valid objects
            ...
            if(propertyName == 'DisplayName' && this.nodes[node.parentId])
            {
                ...
                var oldname = jsDriverPredict.kernel.getProperty(nodeID,'DisplayName');
            ...
            Object.defineProperty( node.methods, methodName, { // "this" is node.methods in get/set
                get: function() {
                    return function( /* parameter1, parameter2, ... */ ) { // "this" is node.methods
                        return jsDriverPredict.kernel.callMethod( this.node.id, methodName, arguments );
                    };
                },
                set: function( value ) {
                    this.node.methods.hasOwnProperty( methodName ) ||
                        jsDriverPredict.kernel.createMethod( this.node.id, methodName );
            ...
            Object.defineProperty( node, methodName, { // "this" is node in get/set
                get: function() {
                    return function( /* parameter1, parameter2, ... */ ) { // "this" is node
                        return jsDriverPredict.kernel.callMethod( this.id, methodName, arguments );
                    };
                },
                set: function( value ) {
                    this.methods.hasOwnProperty( methodName ) ||
                        jsDriverPredict.kernel.createMethod( this.id, methodName );
            ...
            Object.defineProperty( node.events, eventName, { // "this" is node.events in get/set
                get: function() {
                    return function( /* parameter1, parameter2, ... */ ) { // "this" is node.events
                        return jsDriverPredict.kernel.fireEvent( this.node.id, eventName, arguments );
                    };
                },
                set: function( value ) {
...
node.hasOwnProperty( eventName ) ||  // TODO: recalculate as properties, methods, events and children are created and deleted; properties take precedence over methods over events over children, for example
            Object.defineProperty( node, eventName, { // "this" is node in get/set
                get: function() {
                    return function( /* parameter1, parameter2, ... */ ) { // "this" is node
                        return jsDriverPredict.kernel.fireEvent( this.id, eventName, arguments );
                    };
                },
                set: function( value ) {
    ...
    callMethodTraverse:function(node,method,args)
    {
            ...
            if(node.children)
                for(var i =0; i < node.children.length; i++)
                {
                    jsDriverPredict.callMethodTraverse(node.children[i],method,args);
                }
    },    
    ticking: function()
    {
        ...
        firingEvent: function( nodeID, eventName, eventParameters ) {
            ...
            var handled = listeners && listeners.reduce( function( handled, listener ) {
                ...
                if ( ! phase || listener.phases && listener.phases.indexOf( phase ) >= 0 ) {
                    ...
                    var result = listener.handler.apply( listener.context || jsDriverPredict.nodes[0], eventParameters ); // default context is the global root  // TODO: this presumes this.creatingNode( undefined, 0 ) is retained above
            ...
            handled = handled || phase != 'bubble' && node.children && node.children.reduce( function( handled, child ) {
                        ...
                        var result = handled || jsDriverPredict.firingEvent(child.id,eventName, eventParameters); // default context is the global root  // TODO: this presumes this.creatingNode( undefined, 0 ) is retained above
                        return handled || result===true || result===undefined; // interpret no return as "return true"
            }, handled );
            ...
            if ( behavior.properties.hasOwnProperty( propertyName ) ) {
                ...
                ( function( propertyName ) {
                    ...
                    Object.defineProperty( proxy.properties, propertyName, { // "this" is proxy.properties in get/set
                        get: function() { return jsDriverPredict.kernel.getProperty( this.node.id, propertyName ) },
                        set: function( value ) { jsDriverPredict.kernel.setProperty( this.node.id, propertyName, value ) },
                        enumerable: true
                    } );
...
proxy.hasOwnProperty( propertyName ) ||  // TODO: recalculate as properties, methods, events and children are created and deleted; properties take precedence over methods over events over children, for example
                    Object.defineProperty( proxy, propertyName, { // "this" is proxy in get/set
                        get: function() { return jsDriverPredict.kernel.getProperty( this.id, propertyName ) },
                        set: function( value ) { jsDriverPredict.kernel.setProperty( this.id, propertyName, value ) },
                        enumerable: true
                    } );
                ...
                if ( node.properties.hasOwnProperty( propertyName ) ) {
                    ...
                    ( function( propertyName ) {
                        ...
                        Object.defineProperty( future.properties, propertyName, { // "this" is future.properties in get/set
                            get: function() { return jsDriverPredict.kernel.getProperty( this.future.id,
                                propertyName, this.future.private.when, this.future.private.callback
                            ) },
                            set: function( value ) { jsDriverPredict.kernel.setProperty( this.future.id,
...
future.hasOwnProperty( propertyName ) ||  // TODO: calculate so that properties take precedence over methods over events, for example
                        Object.defineProperty( future, propertyName, { // "this" is future in get/set
                            get: function() { return jsDriverPredict.kernel.getProperty( this.id,
                                propertyName, this.private.when, this.private.callback
                            ) },
                            set: function( value ) { jsDriverPredict.kernel.setProperty( this.id,
                        ...
                        Object.defineProperty( future.methods, methodName, { // "this" is future.methods in get/set
                            get: function() {
                                return function( /* parameter1, parameter2, ... */ ) { // "this" is future.methods
                                    return jsDriverPredict.kernel.callMethod( this.future.id,
                        ...
                        Object.defineProperty( future, methodName, { // "this" is future in get/set
                            get: function() {
                                return function( /* parameter1, parameter2, ... */ ) { // "this" is future
                                    return jsDriverPredict.kernel.callMethod( this.id,
                        ...
                        Object.defineProperty( future.events, eventName, { // "this" is future.events in get/set
                            get: function() {
                                return function( /* parameter1, parameter2, ... */ ) { // "this" is future.events
                                    return jsDriverPredict.kernel.fireEvent( this.future.id,
...
future.hasOwnProperty( eventName ) ||  // TODO: calculate so that properties take precedence over methods over events, for example
                        Object.defineProperty( future, eventName, { // "this" is future in get/set
                            get: function() {
                                return function( /* parameter1, parameter2, ... */ ) { // "this" is future
                                    return jsDriverPredict.kernel.fireEvent( this.id,
...
// TODO: this walks the full prototype chain and is probably horribly inefficient.
    ...
    function findListeners( node, eventName, targetOnly ) {
        ...
        var prototypeListeners = Object.getPrototypeOf( node ).private ? // get any jsDriverPredict-targeted listeners from the prototypes
        ...
        if ( targetOnly ) {
            return prototypeListeners.concat( nodeListeners.filter( function( listener ) {
                return listener.context == node || listener.context == node.private.origin; // in the prototypes, select jsDriverPredict-targeted listeners only
            } ) );
        } else {
