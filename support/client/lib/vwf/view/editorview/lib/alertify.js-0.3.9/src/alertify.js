    ...
    Alertify = function() {
        ...
        return {
            ...
            prompt: function(message, fn, placeholder, cssClass) {
                _alertify.dialog(message, "prompt", function(ok, val) {
                    if (ok)
                        autocompleteChoices.push(val);
                    fn(ok, val);
                }, placeholder, cssClass);
                return this;
            },
            choice: function(message, fn, placeholder, cssClass) {
                _alertify.dialog(message, "choice", fn, placeholder, cssClass);
                return this;
            },
