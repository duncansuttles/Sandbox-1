function SplineTool()
{
	...
	$('#SplineToolGUI').append("<input type='checkbox' id='SplineToolGUIEditPoints'></input><label for='SplineToolGUIEditPoints' style = 'display:block'/>");
	$('#SplineToolGUI').append("<input type='checkbox' id='SplineToolGUIRefine'></input><label for='SplineToolGUIRefine' style = 'display:block'/>");
	$('#SplineToolGUI').append("<input type='checkbox' id='SplineToolGUIDraw'></input><label for='SplineToolGUIDraw' style = 'display:block'/>");
	...
	$('#SplineToolGUIEditPoints').button({label:'Active'});
	$('#SplineToolGUIRefine').button({label:'Refine'});
	$('#SplineToolGUIRemove').button({label:'Remove'});
	$('#SplineToolGUIClear').button({label:'Clear'});
	$('#SplineToolGUIDraw').button({label:'Draw'});
	$('#SplineToolGUISmooth').button({label:'Smooth'});
	$('#SplineToolGUIReduce').button({label:'Reduce'});
	...
	$('#SplineToolclose').click(function(){_SplineTool.hide()});
	...
	$('#SplineToolGUIDraw').change(function(e){
