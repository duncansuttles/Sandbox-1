            ...
            if (hit === 1) {
                ...
                for (var j = 0; j < keys.length; j++) {
                    ...
                    if (this.state.nodes[i] && this.state.nodes[i].gettingProperty) {
                        ...
                        this.nodes[i].thisTickTransform = matset(this.nodes[i].thisTickTransform, vwf.views['vwf/view/prediction'].gotProperty(i, 'transform'));


                        this.nodes[i].lastAnimationFrame = this.nodes[i].thisAnimationFrame;
                        this.nodes[i].thisAnimationFrame = vwf.views['vwf/view/prediction'].gotProperty(i, 'animationFrame');
