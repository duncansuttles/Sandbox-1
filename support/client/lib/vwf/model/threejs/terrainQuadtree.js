window.QuadtreeNode = (function() {
		...
		QuadtreeNode.quadtreesetRes =function(s) {
			tileres = s;
		}
		...
		QuadtreeNode.prototype.CPUPick = function(o, d, opts, hits) {
			...
			if (this.mesh) {
				hits = this.mesh.CPUPick(o, d, opts, hits);
			} else {
				if (this.NE())
					hits = this.NE().CPUPick(o, d, opts, hits);
				if (this.NW())
					hits = this.NW().CPUPick(o, d, opts, hits);
				if (this.SE())
					hits = this.SE().CPUPick(o, d, opts, hits);
				if (this.SW())
					hits = this.SW().CPUPick(o, d, opts, hits);
			}
			return hits;
		}
		...
		QuadtreeNode.prototype.isSplit = function() {
			if (this.setForDesplit) return false;
