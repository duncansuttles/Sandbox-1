...
var fireTrap = {
  ...
  "children": {
    "be1fabc2-1784-b4e8-ea76-c326bcc5600e": {
      ...
      "methods": {
        "makeFlameSound": {
          "body": "  this.audioAPI.stopSound(\"../examples/arcade/XAPIGame/flame.mp3\");\n        this.audioAPI.playSound(\"../examples/arcade/XAPIGame/flame.mp3\", false, 100);\n",
          "parameters": []
        },
        "tick": {
